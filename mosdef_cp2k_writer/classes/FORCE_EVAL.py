...
def _validate_STRESS_TENSOR(val, errorLog=[]):
    ...
    if val in STRESS_TENSOR_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for STRESS_TENSOR: {}. Valid options are: {}".format(
...
class FORCE_EVAL:
    def __init__(
        self, METHOD=None, STRESS_TENSOR=None, errorLog=[], changeLog=[], location=""
    ):
        ...
        self.__STRESS_TENSOR = _validate_STRESS_TENSOR(
            STRESS_TENSOR, errorLog=self.__errorLog
        )
