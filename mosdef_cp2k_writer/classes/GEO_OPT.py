...
def _validate_optimizer(val, errorLog=[]):
    ...
    if val in OPTIMIZER_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for GEO_OPT optimizer: {}. Valid options are: {}".format(
                val, OPTIMIZER_VALS
            )
        )
        errorLog.append(
...
def _validate_STEP_START_VAL(val, errorLog=[]):
    if ti.is_positive_integer(val) or (val is None):
        ...
        errorMessage = (
            "The starting step value for the GEO_OPT module must be an integer."
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
...
def _validate_TYPE(val, errorLog=[]):
    ...
    if val in TYPE_VALS or (val is None):
        ...
        errorMessage = "Invalid option for kind of geometry optimization to perform: {}. Valid options are: {}".format(
            val, OPTIMIZER_VALS
        )
        errorLog.append(
            {
...
class GEO_OPT:
    def __init__(
        ...
        self.__STEP_START_VAL = _validate_STEP_START_VAL(
            STEP_START_VAL, errorLog=self.__errorLog
        )
    ...
    def OPTIMIZER(self, val):
        ...
        if val in OPTIMIZER_VALS:
            ...
            errorMessage = "Invalid option for OPTIMIZER in GEO_OPT: {}. Valid options are: {}".format(
                MD_ENSEMBLE_VALS
            )
            self.__changeLog.append(
                {
    ...
    def TYPE(self, val):
        ...
        if val in TYPE_VALS:
            ...
            errorMessage = (
                "Invalid option for TYPE in GEO_OPT: {}. Valid options are: {}".format(
                    val, TYPE_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "STEP_START_VAL",
                    "Success": True,
                    "Previous": self.__STEP_START_VAL,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
