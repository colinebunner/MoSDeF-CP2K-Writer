...
class FM_DIAG_SETTINGS:
    def __init__(
        self,
        ELPA_FORCE_REDISTRIBUTE=None,
        PARAMETER_A=None,
        PARAMETER_X=None,
        PRINT_FM_REDISTRIBUTE=None,
        errorLog=[],
        changeLog=[],
        location="",
    ):
    ...
    def ELPA_FORCE_REDISTRIBUTE(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    ...
                    "Module": "DBCSR",
                    "Variable": "ELPA_FORCE_REDISTRIBUTE",
                    "Success": True,
                    "Previous": self.__ELPA_FORCE_REDISTRIBUTE,
                    "New": val,
                    "ErrorMessage": None,
            ...
            errorMessage = (
                "ELPA_FORCE_REDISTRIBUTE must be a boolean. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
