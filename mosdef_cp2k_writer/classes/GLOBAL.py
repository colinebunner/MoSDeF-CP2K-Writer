import os
import datetime
from mosdef_cp2k_writer.classes import DBCSR
from mosdef_cp2k_writer.classes import FM
from mosdef_cp2k_writer.classes import FM_DIAG_SETTINGS
from mosdef_cp2k_writer.classes import PRINT
from mosdef_cp2k_writer.classes import PRINT_ELPA
...
class GLOBAL:
    def __init__(
        ...
        self.__FM_DIAG_SETTINGS = FM_DIAG_SETTINGS.FM_DIAG_SETTINGS(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        ...
        self.__PRINT_ELPA = PRINT_ELPA.PRINT_ELPA(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__PROGRAM_RUN_INFO = PROGRAM_RUN_INFO.PROGRAM_RUN_INFO(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__REFERENCES = REFERENCES.REFERENCES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__TIMINGS = TIMINGS.TIMINGS(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
            ...
            self.__changeLog.append(
                {
                    ...
                    "Module": "GLOBAL",
                    "Variable": "ALLTOALL_SGL",
                    "Success": True,
                    "Previous": self.__ALLTOALL_SGL,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def BLACS_GRID(self, val):
        ...
        if val in BLACS_GRID_VALS:
            ...
            errorMessage = (
                "BLACS_GRID value not understood. You passed {}. Possible values are: "
    ...
    def BLACS_REPEATABLE(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "BLACS_REPEATABLE",
                    "Success": True,
                    "Previous": self.__BLACS_REPEATABLE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "BLACS_REPEATABLE must be a boolean. You passed {}".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def CALLGRAPH(self, val):
        ...
        if val in CALLGRAPH_VALS:
            ...
            errorMessage = (
                "CALLGRAPH value not understood. You passed {}. Possible values are: "
    ...
    def ECHO_ALL_HOSTS(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "ECHO_ALL_HOSTS",
                    "Success": True,
                    "Previous": self.__ECHO_ALL_HOSTS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "ECHO_ALL_HOSTS must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def ELPA_KERNEL(self, val):
        ...
        if val in ELPA_KERNEL_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "ELPA_KERNEL",
                    "Success": True,
                    "Previous": self.__ELPA_KERNEL,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "ELPA_KERNEL value not understood. You passed {}. Possible values are: "
    ...
    def ELPA_QR_UNSAFE(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "ELPA_QR_UNSAFE",
                    "Success": True,
                    "Previous": self.__ELPA_QR_UNSAFE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "ELPA_QR_UNSAFE must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def EXTENDED_FFT_LENGTHS(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "EXTENDED_FFT_LENGTHS",
                    "Success": True,
                    "Previous": self.__EXTENDED_FFT_LENGTHS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "EXTENDED_FFT_LENGTHS must be a boolean. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def FFTW_PLAN_TYPE(self, val):
        ...
        if val in FFTW_PLAN_TYPE_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "FFTW_PLAN_TYPE",
                    "Success": True,
                    "Previous": self.__FFTW_PLAN_TYPE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "FFTW_PLAN_TYPE value not understood. You passed {}. Possible values are: "
    ...
    def FFTW_WISDOM_FILE_NAME(self, val):
        if os.path.isfile(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "FFT_WISDOM_FILE_NAME",
                    "Success": True,
                    "Previous": self.__FFT_WISDOM_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "FFT_WISDOM_FILE_NAME can't be set: file {} doesn't exist.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "FFTW_WISDOM_FILE_NAME",
                    "Success": False,
                    "Previous": self.__FFTW_WISDOM_FILE_NAME,
                    "New": val,
                    "ErrorMessage": errorMessage,
                    "Location": self.__location,
                }
    ...
    def FFT_POOL_SCRATCH_LIMIT(self, val):
        if utilities.is_number(val):
            ...
            errorMessage = (
                "FFT_POOL_SCRATCH_LIMIT must be a number. You passed {}".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def FLUSH_SHOULD_FLUSH(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "FLUSH_SHOULD_FLUSH",
                    "Success": True,
                    "Previous": self.__FLUSH_SHOULD_FLUSH,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "FLUSH_SHOULD_FLUSH must be a boolean. You passed {}".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def PREFERRED_DIAG_LIBRARY(self, val):
        ...
        if val in PREFERRED_DIAG_LIBRARY_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "PREFERRED_DIAG_LIBRARY",
                    "Success": True,
                    "Previous": self.__PREFERRED_DIAG_LIBRARY,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PREFERRED_DIAG_LIBRARY value not understood. You passed {}. Possible values are: "
    ...
    def PREFERRED_FFT_LIBRARY(self, val):
        ...
        if val in PREFERRED_FFT_LIBRARY_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "PREFERRED_FFT_LIBRARY",
                    "Success": True,
                    "Previous": self.__PREFERRED_FFT_LIBRARY,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PREFERRED_FFT_LIBRARY value not understood. You passed {}. Possible values are: "
    ...
    def PRINT_LEVEL(self, val):
        ...
        if val in PRINT_LEVEL_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "PRINT_LEVEL",
                    "Success": True,
                    "Previous": self.__PRINT_LEVEL,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PRINT_LEVEL value not understood. You passed {}. Possible values are: "
    ...
    def RUN_TYPE(self, val):
        ...
        if val in RUN_TYPE_VALS:
            ...
            errorMessage = (
                "RUN_TYPE {} not allowed. Check for typo. Allowed values "
            ...
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "GLOBAL",
                    "Variable": "TRACE_MASTER",
                    "Success": True,
                    "Previous": self.__TRACE_MASTER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
