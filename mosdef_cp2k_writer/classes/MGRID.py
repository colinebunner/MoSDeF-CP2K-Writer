...
def _validate_COMMENSURATE(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for COMMENSURATE: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_MULTIGRID_SET(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MULTIGRID_SET: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "DFT.MGRID",
                "Variable": "SKIP_LOAD_BALANCE_DISTRIBUTED",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
class MGRID:
    def __init__(
        ...
        self.__COMMENSURATE = _validate_COMMENSURATE(
            COMMENSURATE, errorLog=self.__errorLog
        )
        self.__CUTOFF = _validate_CUTOFF(CUTOFF, errorLog=self.__errorLog)
        self.__MULTIGRID_CUTOFF = _validate_MULTIGRID_CUTOFF(
            MULTIGRID_CUTOFF, errorLog=self.__errorLog
        )
        self.__MULTIGRID_SET = _validate_MULTIGRID_SET(
            MULTIGRID_SET, errorLog=self.__errorLog
        )
        self.__NGRIDS = _validate_NGRIDS(NGRIDS, errorLog=self.__errorLog)
        self.__PROGRESSION_FACTOR = _validate_PROGRESSION_FACTOR(
            PROGRESSION_FACTOR, errorLog=self.__errorLog
        )
        ...
        self.__SKIP_LOAD_BALANCE_DISTRIBUTED = _validate_SKIP_LOAD_BALANCE_DISTRIBUTED(
            SKIP_LOAD_BALANCE_DISTRIBUTED, errorLog=self.__errorLog
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.GRID",
                "Variable": "MULTIGRID_CUTOFF",
                "Success": True,
                "Previous": self.__MULTIGRID_CUTOFF,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.GRID",
                "Variable": "PROGRESSION_FACTOR",
                "Success": True,
                "Previous": self.__PROGRESSION_FACTOR,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
    ...
    def REALSPACE(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for REALSPACE: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "SKIP_LOAD_BALANCE_DISTRIBUTED",
                    "Success": True,
                    "Previous": self.__SKIP_LOAD_BALANCE_DISTRIBUTED,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
