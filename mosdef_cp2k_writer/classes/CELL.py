...
def _validate_CELL_FILE_FORMAT(val, errorLog=[]):
    ...
    if val in CELL_FILE_FORMAT_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CELL_FILE_FORMAT: {}. Valid options are: {}".format(
...
class CELL:
    def __init__(
        ...
        self.__ALPHA_BETA_GAMMA = _validate_ALPHA_BETA_GAMMA(
            ALPHA_BETA_GAMMA, errorLog=self.__errorLog
        )
        self.__B = _validate_B(B, errorLog=self.__errorLog)
        self.__C = _validate_C(C, errorLog=self.__errorLog)
        self.__CELL_FILE_FORMAT = _validate_CELL_FILE_FORMAT(
            CELL_FILE_FORMAT, errorLog=self.__errorLog
        )
    ...
    def PERIODIC(self, val):
        ...
        if val in PERIODIC_VALS:
            ...
            errorMessage = (
                "Invalid option for PERIODIC: {}. Valid options are: {}".format(
                    val, PERIODIC_VALS
                )
            )
            self.__changeLog.append(
    ...
    def SYMMETRY(self, val):
        ...
        if val in SYMMETRY_VALS:
            ...
            errorMessage = (
                "Invalid option for SYMMETRY: {}. Valid options are: {}".format(
                    val, SYMMETRY_VALS
                )
            )
            self.__changeLog.append(
