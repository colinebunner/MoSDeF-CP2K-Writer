...
class ACC:
    def __init__(
        self,
        AVOID_AFTER_BUSY=None,
        BINNING_BINSIZE=None,
        BINNING_NBINS=None,
        MIN_FLOP_PROCESS=None,
        MIN_FLOP_SORT=None,
        POSTERIOR_BUFFERS=None,
        POSTERIOR_STREAMS=None,
        PRIORITY_BUFFERS=None,
        PRIORITY_STREAMS=None,
        PROCESS_INHOMOGENOUS=None,
        STACK_SORT=None,
        errorLog=[],
        changeLog=[],
        location="",
    ...
    def AVOID_AFTER_BUSY(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    ...
                    "Module": "ACC",
                    "Variable": "AVOID_AFTER_BUSY",
                    "Success": True,
                    "Previous": self.__AVOID_AFTER_BUSY,
                    "New": val,
                    "ErrorMessage": None,
            ...
            errorMessage = "AVOID_AFTER_BUSY must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def BINNING_BINSIZE(self, val):
        if ti.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "BINNING_BINSIZE",
                    "Success": True,
                    "Previous": self.__BINNING_BINSIZE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "BINNING_BINSIZE must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def BINNING_NBINS(self, val):
        if ti.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "BINNING_NBINS",
                    "Success": True,
                    "Previous": self.__BINNING_NBINS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "BINNING_NBINS must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def MIN_FLOP_PROCESS(self, val):
        if ti.is_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "MIN_FLOP_PROCESS",
                    "Success": True,
                    "Previous": self.__MIN_FLOP_PROCESS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "MIN_FLOP_PROCESS must be an integer. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def POSTERIOR_BUFFERS(self, val):
        if ti.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "POSTERIOR_BUFFERS",
                    "Success": True,
                    "Previous": self.__POSTERIOR_BUFFERS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "POSTERIOR_BUFFERS must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def PRIORITY_BUFFERS(self, val):
        if ti.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "PRIORITY_BUFFERS",
                    "Success": True,
                    "Previous": self.__PRIORITY_BUFFERS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PRIORITY_BUFFERS must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def PRIORITY_STREAMS(self, val):
        if ti.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "PRIORITY_STREAMS",
                    "Success": True,
                    "Previous": self.__PRIORITY_STREAMS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PRIORITY_STREAMS must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def PROCESS_INHOMOGENOUS(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "ACC",
                    "Variable": "PROCESS_INHOMOGENOUS",
                    "Success": True,
                    "Previous": self.__PROCESS_INHOMOGENOUS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "PROCESS_INHOMOGENOUS must be a boolean. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
