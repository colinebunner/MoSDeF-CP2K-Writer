...
from mosdef_cp2k_writer.classes import MOVE_UPDATES as move_updates
...
def _validate_ENSEMBLE(val, errorLog=[]):
    ...
    if val in MC_ENSEMBLE_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MC ENSEMBLE: {}. Valid options are: {}".format(
                val, MC_ENSEMBLE_VALS
            )
        )
        errorLog.append(
            {
...
def _validate_LBIAS(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = "Invalid option for LBIAS: {}. Valid options are: {}".format(
            val, BOOL_VALS
        )
        errorLog.append(
            {
...
def _validate_LDISCRETE(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = "Invalid option for LDISCRETE: {}. Valid options are: {}".format(
            val, BOOL_VALS
        )
        errorLog.append(
            {
...
def _validate_LSTOP(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = "Invalid option for LSTOP: {}. Valid options are: {}".format(
            val, BOOL_VALS
        )
        errorLog.append(
            {
...
def _validate_RESTART(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = "Invalid option for RESTART: {}. Valid options are: {}".format(
            val, BOOL_VALS
        )
        errorLog.append(
            {
...
class MC:
    def __init__(
        ...
        LDISCRETE=None,
        LSTOP=None,
        MAX_DISP_FILE_NAME=None,
        MOLECULES_FILE_NAME=None,
        MOVES_FILE_NAME=None,
        NMOVES=None,
        NSTEP=None,
        NSWAPMOVES=None,
        NVIRIAL=None,
        ...
        self.__BOX2_FILE_NAME = _validate_BOX2_FILE_NAME(
            BOX2_FILE_NAME, errorLog=self.__errorLog
        )
        self.__CELL_FILE_NAME = _validate_CELL_FILE_NAME(
            CELL_FILE_NAME, errorLog=self.__errorLog
        )
        self.__COORDINATE_FILE_NAME = _validate_COORDINATE_FILE_NAME(
            COORDINATE_FILE_NAME, errorLog=self.__errorLog
        )
        self.__DATA_FILE_NAME = _validate_DATA_FILE_NAME(
            DATA_FILE_NAME, errorLog=self.__errorLog
        )
        self.__DISCRETE_STEP = _validate_DISCRETE_STEP(
            DISCRETE_STEP, errorLog=self.__errorLog
        )
        self.__ENERGY_FILE_NAME = _validate_ENERGY_FILE_NAME(
            ENERGY_FILE_NAME, errorLog=self.__errorLog
        )
        ...
        self.__MAX_DISP_FILE_NAME = _validate_MAX_DISP_FILE_NAME(
            MAX_DISP_FILE_NAME, errorLog=self.__errorLog
        )
        self.__MOLECULES_FILE_NAME = _validate_MOLECULES_FILE_NAME(
            MOLECULES_FILE_NAME, errorLog=self.__errorLog
        )
        self.__MOVES_FILE_NAME = _validate_MOVES_FILE_NAME(
            MOVES_FILE_NAME, errorLog=self.__errorLog
        )
        ...
        self.__RANDOMTOSKIP = _validate_RANDOMTOSKIP(
            RANDOMTOSKIP, errorLog=self.__errorLog
        )
        ...
        self.__RESTART_FILE_NAME = _validate_RESTART_FILE_NAME(
            RESTART_FILE_NAME, errorLog=self.__errorLog
        )
        self.__TEMPERATURE = _validate_TEMPERATURE(
            TEMPERATURE, errorLog=self.__errorLog
        )
        self.__VIRIAL_TEMPS = _validate_VIRIAL_TEMPS(
            VIRIAL_TEMPS, errorLog=self.__errorLog
        )
        self.__location = "{}/MC".format(location)
        # MC subesctions
        self.__AVBMC = avbmc.AVBMC(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__MAX_DISPLACEMENTS = max_displacements.MAX_DISPLACEMENTS(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__MOVE_PROBABILITIES = move_probabilities.MOVE_PROBABILITIES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__MOVE_UPDATES = move_updates.MOVE_UPDATES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
    ...
    def BOX2_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "BOX2_FILE_NAME",
                    "Success": True,
                    "Previous": self.__BOX2_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for BOX2_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def CELL_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    ...
                    "Success": True,
                    "Previous": self.__CELL_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for CELL_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def COORDINATE_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "COORDINATE_FILE_NAME",
                    "Success": True,
                    "Previous": self.__COORDINATE_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for COORDINATE_FILE_NAME: {}. Must be a string".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def DATA_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    ...
                    "Success": True,
                    "Previous": self.__DATA_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for DATA_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def DISCRETE_STEP(self, val):
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for DISCRETE_STEP: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def ENERGY_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "ENERGY_FILE_NAME",
                    "Success": True,
                    "Previous": self.__ENERGY_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for ENERGY_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def ENSEMBLE(self, val):
        if val is None or val in MC_ENSEMBLE_VALS:
            ...
            errorMessage = "Invalid option for ENSEMBLE: {}. Must be one of these values: {}".format(
                val, MC_ENSEMBLE_VALS
            )
            self.__changeLog.append(
                {
    ...
    def IPRINT(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = "Invalid option for IPRINT: {}. Must be an integer".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def LBIAS(self, val):
        if val is None or val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for LBIAS: {}. Must be one of these values: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
    ...
    def LDISCRETE(self, val):
        if val is None or val in BOOL_VALS:
            ...
            errorMessage = "Invalid option for LDISCRETE: {}. Must be one of these values: {}".format(
                val, BOOL_VALS
            )
            self.__changeLog.append(
                {
    ...
    def LSTOP(self, val):
        if val is None or val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for LSTOP: {}. Must be one of these values: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
    ...
    def MAX_DISP_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "MAX_DISP_FILE_NAME",
                    "Success": True,
                    "Previous": self.__MAX_DISP_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for MAX_DISP_FILE_NAME: {}. Must be a string".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def MOLECULES_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "MOLECULES_FILE_NAME",
                    "Success": True,
                    "Previous": self.__MOLECULES_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for MOLECULES_FILE_NAME: {}. Must be a string".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def MOVES_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "MOVES_FILE_NAME",
                    "Success": True,
                    "Previous": self.__MOVES_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for MOVES_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def NMOVES(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = "Invalid option for NMOVES: {}. Must be an integer".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def NSTEP(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = "Invalid option for NSTEP: {}. Must be an integer".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def NSWAPMOVES(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = (
                "Invalid option for NSWAPMOVES: {}. Must be an integer".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def NVIRIAL(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = "Invalid option for NVIRIAL: {}. Must be an integer".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def PRESSURE(self, val):
        if val is None or utilities.is_number(val):
            ...
            errorMessage = "Invalid option for PRESSURE: {}. Must be a number".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def RANDOMTOSKIP(self, val):
        if val is None or utilities.is_integer(val):
            ...
            errorMessage = (
                "Invalid option for RANDOMTOSKIP: {}. Must be an integer".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def RESTART(self, val):
        if val is None or val in BOOL_VALS:
            ...
            errorMessage = "Invalid option for RESTART: {}. Must be one of these values: {}".format(
                val, BOOL_VALS
            )
            self.__changeLog.append(
                {
    ...
    def RESTART_FILE_NAME(self, val):
        if val is None or utilities.is_string(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "MC",
                    "Variable": "RESTART_FILE_NAME",
                    "Success": True,
                    "Previous": self.__RESTART_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "Invalid option for RESTART_FILE_NAME: {}. Must be a string".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def TEMPERATURE(self, val):
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for TEMPERATURE: {}. Must be a number".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def VIRIAL_TEMPS(self, val):
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for VIRIAL_TEMPS: {}. Must be a number".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
