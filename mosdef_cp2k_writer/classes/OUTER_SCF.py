...
class OUTER_SCF:
    def __init__(
        ...
        BISECT_TRUST_COUNT=None,
        DIIS_BUFFER_LENGTH=None,
        EPS_SCF=None,
        ...
        self.__BISECT_TRUST_COUNT = _validate_BISECT_TRUST_COUNT(
            BISECT_TRUST_COUNT, errorLog=self.__errorLog
        )
        self.__DIIS_BUFFER_LENGTH = _validate_DIIS_BUFFER_LENGTH(
            DIIS_BUFFER_LENGTH, errorLog=self.__errorLog
        )
    ...
    def SECTION_PARAMETERS(self, val):
        ...
        if val in SECTION_PARAMETERS_VALS:
            ...
            errorMessage = "Invalid option for Section parameter OUTER_SCF: {}. Valid options are: {}".format(
                val, SECTION_PARAMETERS_VALS
            )
            self.__changeLog.append(
                {
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "BISECT_TRUST_COUNT",
                    "Success": True,
                    "Previous": self.__BISECT_TRUST_COUNT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "DIIS_BUFFER_LENGTH",
                    "Success": True,
                    "Previous": self.__DIIS_BUFFER_LENGTH,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def OPTIMIZER(self, val):
        ...
        if val in OPTIMIZER_VALS:
            ...
            errorMessage = "Invalid option for OPTIMIZER OUTER_SCF: {}. Valid options are: {}".format(
                val, OPTIMIZER_VALS
            )
            self.__changeLog.append(
                {
