        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SUBSYS.KIND",
                "Variable": "FLOATING_BASIS_CENTER",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_NO_OPTIMIZE(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for NO_OPTIMIZE: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_SE_P_ORBITALS_ON_H(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for SE_P_ORBITALS_ON_H: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class KINDs:
    def __init__(
        ...
        ELEC_CONF=None,
        ELEMENT=None,
        FLOATING_BASIS_CENTER=None,
        GHOST=None,
        GPW_TYPE=None,
        HARD_EXP_RADIUS=None,
        KG_POTENTIAL=None,
        KG_POTENTIAL_FILE_NAME=None,
        LEBEDEV_GRID=None,
        LMAX_DFTB=None,
        LRI_BASIS_SET=None,
        MAGNETIZATION=None,
        ...
        self.__AUX_BASIS_SET = _validate_AUX_BASIS_SET(
            AUX_BASIS_SET, errorLog=self.__errorLog
        )
        self.__AUX_FIT_BASIS_SET = _validate_AUX_FIT_BASIS_SET(
            AUX_FIT_BASIS_SET, errorLog=self.__errorLog
        )
        self.__BASIS_SET = _validate_BASIS_SET(BASIS_SET, errorLog=self.__errorLog)
        self.__CORE_CORRECTION = _validate_CORE_CORRECTION(
            CORE_CORRECTION, errorLog=self.__errorLog
        )
        self.__DFTB3_PARAM = _validate_DFTB3_PARAM(
            DFTB3_PARAM, errorLog=self.__errorLog
        )
        ...
        self.__FLOATING_BASIS_CENTER = _validate_FLOATING_BASIS_CENTER(
            FLOATING_BASIS_CENTER, errorLog=self.__errorLog
        )
        ...
        self.__HARD_EXP_RADIUS = _validate_HARD_EXP_RADIUS(
            HARD_EXP_RADIUS, errorLog=self.__errorLog
        )
        self.__KG_POTENTIAL = _validate_KG_POTENTIAL(
            KG_POTENTIAL, errorLog=self.__errorLog
        )
        self.__KG_POTENTIAL_FILE_NAME = _validate_KG_POTENTIAL_FILE_NAME(
            KG_POTENTIAL_FILE_NAME, errorLog=self.__errorLog
        )
        self.__LEBEDEV_GRID = _validate_LEBEDEV_GRID(
            LEBEDEV_GRID, errorLog=self.__errorLog
        )
        self.__LMAX_DFTB = _validate_LMAX_DFTB(LMAX_DFTB, errorLog=self.__errorLog)
        self.__LRI_BASIS_SET = _validate_LRI_BASIS_SET(
            LRI_BASIS_SET, errorLog=self.__errorLog
        )
        self.__MAGNETIZATION = _validate_MAGNETIZATION(
            MAGNETIZATION, errorLog=self.__errorLog
        )
        ...
        self.__NO_OPTIMIZE = _validate_NO_OPTIMIZE(
            NO_OPTIMIZE, errorLog=self.__errorLog
        )
        self.__PAO_BASIS_SIZE = _validate_PAO_BASIS_SIZE(
            PAO_BASIS_SIZE, errorLog=self.__errorLog
        )
        self.__POTENTIAL = _validate_POTENTIAL(POTENTIAL, errorLog=self.__errorLog)

        self.__POTENTIAL_FILE_NAME = _validate_POTENTIAL_FILE_NAME(
            POTENTIAL_FILE_NAME, errorLog=self.__errorLog
        )
        self.__POTENTIAL_TYPE = _validate_POTENTIAL_TYPE(
            POTENTIAL_TYPE, errorLog=self.__errorLog
        )
        self.__RADIAL_GRID = _validate_RADIAL_GRID(
            RADIAL_GRID, errorLog=self.__errorLog
        )
        self.__RHO0_EXP_RADIUS = _validate_RHO0_EXP_RADIUS(
            RHO0_EXP_RADIUS, errorLog=self.__errorLog
        )
        self.__RI_AUX_BASIS_SET = _validate_RI_AUX_BASIS_SET(
            RI_AUX_BASIS_SET, errorLog=self.__errorLog
        )
        self.__SE_P_ORBITALS_ON_H = _validate_SE_P_ORBITALS_ON_H(
            SE_P_ORBITALS_ON_H, errorLog=self.__errorLog
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "AUX_BASIS_SET",
                "Success": True,
                "Previous": self.__AUX_BASIS_SET,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "AUX_FIT_BASIS_SET",
                "Success": True,
                "Previous": self.__AUX_FIT_BASIS_SET,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "CORE_CORRECTION",
                "Success": True,
                "Previous": self.__CORE_CORRECTION,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "DFTB3_PARAM",
                "Success": True,
                "Previous": self.__DFTB3_PARAM,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "FLOATING_BASIS_CENTER",
                    "Success": True,
                    "Previous": self.__FLOATING_BASIS_CENTER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def GPW_TYPE(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for GPW_TYPE: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "HARD_EXP_RADIUS",
                "Success": True,
                "Previous": self.__HARD_EXP_RADIUS,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "KG_POTENTIAL",
                "Success": True,
                "Previous": self.__KG_POTENTIAL,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "KG_POTENTIAL_FILE_NAME",
                "Success": True,
                "Previous": self.__KG_POTENTIAL_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "LRI_BASIS_SET",
                "Success": True,
                "Previous": self.__LRI_BASIS_SET,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "PAO_BASIS_SIZE",
                    "Success": True,
                    "Previous": self.__PAO_BASIS_SIZE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "POTENTIAL_FILE_NAME",
                "Success": True,
                "Previous": self.__POTENTIAL_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                ...
                "Success": True,
                "Previous": self.__POTENTIAL_TYPE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "RHO0_EXP_RADIUS",
                "Success": True,
                "Previous": self.__RHO0_EXP_RADIUS,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SUBSYS.KIND",
                "Variable": "RI_AUX_BASIS_SET",
                "Success": True,
                "Previous": self.__RI_AUX_BASIS_SET,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "SE_P_ORBITALS_ON_H",
                    "Success": True,
                    "Previous": self.__SE_P_ORBITALS_ON_H,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
