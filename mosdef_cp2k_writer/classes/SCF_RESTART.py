...
def _validate_SPLIT_RESTART_FILE(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for SPLIT_RESTART_FILE: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "SPLIT_RESTART_FILE",
                    "Success": True,
                    "Previous": self.__SPLIT_RESTART_FILE,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
