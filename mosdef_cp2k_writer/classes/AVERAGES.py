...
def _validate_AVERAGE_COLVAR(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for AVERAGE_COLVAR: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class AVERAGES:
    def __init__(
        ...
        self.__ACQUISITION_START_TIME = _validate_ACQUISITION_START_TIME(
            ACQUISITION_START_TIME, errorLog=self.__errorLog
        )
        self.__AVERAGE_COLVAR = _validate_AVERAGE_COLVAR(
            ACQUISITION_START_TIME, errorLog=self.__errorLog
        )
    ...
    def ACQUISITION_START_TIME(self, val):
        if utilities.is_positive_number(val):
            ...
            errorMessage = "Invalid option for ACQUISITION_START_TIME: {}".format(val)
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "AVERAGES",
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "AVERAGE_COLVAR",
                    "Success": True,
                    "Previous": self.__AVERAGE_COLVAR,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
