...
from mosdef_cp2k_writer.classes import PAIR_POTENTIAL
...
def _validate_POTENTIAL_TYPE(val, errorLog=[]):
    ...
    if val in POTENTIAL_TYPE_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for  POTENTIAL_TYPE: {}. Valid options are: {}".format(
...
class VDW_POTENTIAL:
    def __init__(self, POTENTIAL_TYPE=None, errorLog=[], changeLog=[], location=""):
        ...
        self.__PAIR_POTENTIAL = PAIR_POTENTIAL.PAIR_POTENTIAL(
