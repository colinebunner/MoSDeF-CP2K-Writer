...
class DBCSR:
    def __init__(
        self,
        AVG_ELEMENTS_IMAGES=None,
        COMM_THREAD_LOAD=None,
        MAX_ELEMENTS_PER_BLOCK=None,
        MM_DRIVER=None,
        MM_STACK_SIZE=None,
        MULTREC_LIMIT=None,
        NUM_LAYERS_3D=None,
        NUM_MULT_IMAGES=None,
        N_SIZE_MNK_STACKS=None,
        USE_COMM_THREAD=None,
        USE_MPI_ALLOCATOR=None,
        USE_MPI_RMA=None,
        errorLog=[],
        changeLog=[],
        location="",
    ...
    def AVG_ELEMENTS_IMAGES(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    ...
                    "Module": "DBCSR",
                    "Variable": "AVG_ELEMENTS_IMAGES",
                    "Success": True,
                    "Previous": self.__AVG_ELEMENTS_IMAGES,
                    "New": val,
                    "ErrorMessage": None,
            ...
            errorMessage = (
                "AVG_ELEMENTS_IMAGES must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
                {
                    ...
                    "Variable": "AVG_ELEMENTS_IMAGES",
                    "Success": False,
                    "Previous": self.__AVG_ELEMENTS_IMAGE,
                    "New": val,
    ...
    def COMM_THREAD_LOAD(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "COMM_THREAD_LOAD",
                    "Success": True,
                    "Previous": self.__COMM_THREAD_LOAD,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "COMM_THREAD_LOAD must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def MAX_ELEMENTS_PER_BLOCK(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "MAX_ELEMENTS_PER_BLOCK",
                    "Success": True,
                    "Previous": self.__MAX_ELEMENTS_PER_BLOCK,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "MAX_ELEMENTS_PER_BLOCK must be a positive integer. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def MM_DRIVER(self, val):
        ...
        if val in DBCSR.MM_DRIVER_VALS:
            ...
            errorMessage = (
                "MM_DRIVER val can't be understood. You passed {}. Allowed values for MM_DRIVER are"
    ...
    def MULTREC_LIMIT(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "MULTREC_LIMIT",
                    "Success": True,
                    "Previous": self.__MULTREC_LIMIT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "MULTREC_LIMIT must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def NUM_LAYERS_3D(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "NUM_LAYERS_3D",
                    "Success": True,
                    "Previous": self.__NUM_LAYERS_3D,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "NUM_LAYERS_3D must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def NUM_MULT_IMAGES(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "NUM_MULT_IMAGES",
                    "Success": True,
                    "Previous": self.__NUM_MULT_IMAGES,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "NUM_MULT_IMAGES must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def N_SIZE_MNK_STACKS(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "N_SIZE_MNK_STACKS",
                    "Success": True,
                    "Previous": self.__N_SIZE_MNK_STACKS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "N_SIZE_MNK_STACKS must be a positive integer. You passed {}.".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def USE_COMM_THREAD(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "USE_COMM_THREAD",
                    "Success": True,
                    "Previous": self.__USE_COMM_THREAD,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "USE_COMM_THREAD must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def USE_MPI_ALLOCATOR(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "USE_MPI_ALLOCATOR",
                    "Success": True,
                    "Previous": self.__USE_MPI_ALLOCATOR,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "USE_MPI_ALLOCATOR must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
            ...
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "USE_MPI_RMA",
                    "Success": True,
                    "Previous": self.__USE_MPI_RMA,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
