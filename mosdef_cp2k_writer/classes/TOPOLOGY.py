        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SUBSYS.TOPOLOGY",
                "Variable": "AUTOGEN_EXCLUDE_LISTS",
...
def _validate_CHARGE_BETA(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CHARGE_BETA: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_CHARGE_EXTENDED(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CHARGE_EXTENDED: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_CHARGE_OCCUP(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CHARGE_OCCUP: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_CONN_FILE_FORMAT(val, errorLog=[]):
    ...
    if val in CONN_FILE_FORMAT_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CONN_FILE_FORMAT: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_CONN_FILE_NAME(val, errorLog=[]):
    if is_string(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for CONN_FILE_NAME: {}. It should be a string".format(val)
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
...
def _validate_COORD_FILE_FORMAT(val, errorLog=[]):
    ...
    if val in COORD_FILE_FORMAT_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for COORD_FILE_FORMAT: {}. Valid options are: {}".format(
...
def _validate_COORD_FILE_NAME(val, errorLog=[]):
    if is_string(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for COORD_FILE_NAME: {}. It should be a string".format(val)
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SUBSYS.TOPOLOGY",
                "Variable": "DISABLE_EXCLUSION_LISTS",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_EXCLUDE_EI(val, errorLog=[]):
    ...
    if val in EXCLUDE_EI_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for EXCLUDE_EI: {}. Valid options are: {}".format(
                val, EXCLUDE_EI_VALS
            )
        )
        errorLog.append(
...
def _validate_EXCLUDE_VDW(val, errorLog=[]):
    ...
    if val in EXCLUDE_VDW_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for EXCLUDE_VDW: {}. Valid options are: {}".format(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SUBSYS.TOPOLOGY",
                "Variable": "MEMORY_PROGRESSION_FACTOR",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_USE_ELEMENT_AS_KIND(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for USE_ELEMENT_AS_KIND: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_USE_G96_VELOCITY(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for USE_G96_VELOCITY: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class TOPOLOGY:
    def __init__(
        self,
        AUTOGEN_EXCLUDE_LISTS=None,
        CHARGE_BETA=None,
        CHARGE_EXTENDED=None,
        CHARGE_OCCUP=None,
        CONN_FILE_FORMAT=None,
        CONN_FILE_NAME=None,
        COORD_FILE_FORMAT=None,
        COORD_FILE_NAME=None,
        DISABLE_EXCLUSION_LISTS=None,
        EXCLUDE_EI=None,
        EXCLUDE_VDW=None,
        MEMORY_PROGRESSION_FACTOR=None,
        MOL_CHECK=None,
        MULTIPLE_UNIT_CELL=None,
        NUMBER_OF_ATOMS=None,
        PARA_RES=None,
        USE_ELEMENT_AS_KIND=None,
        USE_G96_VELOCITY=None,
        errorLog=[],
        changeLog=[],
        location="",
    ):
        ...
        self.__AUTOGEN_EXCLUDE_LISTS = _validate_AUTOGEN_EXCLUDE_LISTS(
            AUTOGEN_EXCLUDE_LISTS, errorLog=self.__errorLog
        )
        self.__CHARGE_BETA = _validate_CHARGE_BETA(
            CHARGE_BETA, errorLog=self.__errorLog
        )
        self.__CHARGE_EXTENDED = _validate_CHARGE_EXTENDED(
            CHARGE_EXTENDED, errorLog=self.__errorLog
        )
        self.__CHARGE_OCCUP = _validate_CHARGE_OCCUP(
            CHARGE_OCCUP, errorLog=self.__errorLog
        )
        self.__CONN_FILE_FORMAT = _validate_CONN_FILE_FORMAT(
            CONN_FILE_FORMAT, errorLog=self.__errorLog
        )
        self.__CONN_FILE_NAME = _validate_CONN_FILE_NAME(
            CONN_FILE_NAME, errorLog=self.__errorLog
        )
        self.__COORD_FILE_FORMAT = _validate_COORD_FILE_FORMAT(
            COORD_FILE_FORMAT, errorLog=self.__errorLog
        )
        self.__COORD_FILE_NAME = _validate_COORD_FILE_NAME(
            COORD_FILE_NAME, errorLog=self.__errorLog
        )
        self.__DISABLE_EXCLUSION_LISTS = _validate_DISABLE_EXCLUSION_LISTS(
            DISABLE_EXCLUSION_LISTS, errorLog=self.__errorLog
        )
        self.__EXCLUDE_EI = _validate_EXCLUDE_EI(EXCLUDE_EI, errorLog=self.__errorLog)
        self.__EXCLUDE_VDW = _validate_EXCLUDE_VDW(
            EXCLUDE_VDW, errorLog=self.__errorLog
        )
        self.__MEMORY_PROGRESSION_FACTOR = _validate_MEMORY_PROGRESSION_FACTOR(
            MEMORY_PROGRESSION_FACTOR, errorLog=self.__errorLog
        )
        self.__MOL_CHECK = _validate_MOL_CHECK(MOL_CHECK, errorLog=self.__errorLog)
        self.__MULTIPLE_UNIT_CELL = _validate_MULTIPLE_UNIT_CELL(
            MULTIPLE_UNIT_CELL, errorLog=self.__errorLog
        )
        self.__NUMBER_OF_ATOMS = _validate_NUMBER_OF_ATOMS(
            NUMBER_OF_ATOMS, errorLog=self.__errorLog
        )
        self.__PARA_RES = _validate_PARA_RES(PARA_RES, errorLog=self.__errorLog)
        self.__USE_ELEMENT_AS_KIND = _validate_USE_ELEMENT_AS_KIND(
            USE_ELEMENT_AS_KIND, errorLog=self.__errorLog
        )
        self.__USE_G96_VELOCITY = _validate_USE_G96_VELOCITY(
            USE_G96_VELOCITY, errorLog=self.__errorLog
        )
        self.__CENTER_COORDINATES = CENTER_COORDINATES.CENTER_COORDINATES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__MOL_SET = MOL_SET.MOL_SET(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "AUTOGEN_EXCLUDE_LISTS",
                    "Success": True,
                    "Previous": self.__AUTOGEN_EXCLUDE_LISTS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "CHARGE_EXTENDED",
                    "Success": True,
                    "Previous": self.__CHARGE_EXTENDED,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "CONN_FILE_FORMAT",
                    "Success": True,
                    "Previous": self.__CONN_FILE_FORMAT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def CONN_FILE_NAME(self, val):
        if is_string(val):
            ...
            errorMessage = (
                "Invalid option for CONN_FILE_NAME: {}. it should be a string".format(
                    val
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "COORD_FILE_FORMAT",
                    "Success": True,
                    "Previous": self.__COORD_FILE_FORMAT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def COORD_FILE_NAME(self, val):
        if is_string(val):
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "COORD_FILE_NAME",
                    "Success": True,
                    "Previous": self.__COORD_FILE_NAME,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "Invalid option for COCOORD_FILE_NAME: {}. it should be a string".format(
                val
            )
            self.__changeLog.append(
                {
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "DISABLE_EXCLUSION_LISTS",
                    "Success": True,
                    "Previous": self.__DISABLE_EXCLUSION_LISTS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def EXCLUDE_EI(self, val):
        if val in EXCLUDE_EI_VALS:
            ...
            errorMessage = (
                "Invalid option for EXCLUDE_EI: {}. it should be one of {}".format(
                    val, EXCLUDE_EI_VALS
                )
            )
            self.__changeLog.append(
    ...
    def EXCLUDE_VDW(self, val):
        if val in EXCLUDE_VDW_VALS:
            ...
            errorMessage = (
                "Invalid option for EXCLUDE_VDW: {}. it should be one of {}".format(
                    val, EXCLUDE_VDW_VALS
                )
            )
            self.__changeLog.append(
    ...
    def MEMORY_PROGRESSION_FACTOR(self, val):
        if is_number(val):
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "MEMORY_PROGRESSION_FACTOR",
                    "Success": True,
                    "Previous": self.__MEMORY_PROGRESSION_FACTOR,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "Invalid option for MEMORY_PROGRESSION_FACTOR: {}. it should be a string".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def MOL_CHECK(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for MOL_CHECK: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
    ...
    def MULTIPLE_UNIT_CELL(self, val):
        if is_list_of_numbers(val):
            ...
            errorMessage = "Invalid option for MULTIPLE_UNIT_CELL: {}. it should be a list of numbers".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def NUMBER_OF_ATOMS(self, val):
        if is_positive_integer(val):
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "NUMBER_OF_ATOMS",
                    "Success": True,
                    "Previous": self.__NUMBER_OF_ATOMS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = "Invalid option for NUMBER_OF_ATOMS: {}. it should be a positive integer".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def PARA_RES(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for PARA_RES: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "USE_ELEMENT_AS_KIND",
                    "Success": True,
                    "Previous": self.__USE_ELEMENT_AS_KIND,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "USE_G96_VELOCITY",
                    "Success": True,
                    "Previous": self.__USE_G96_VELOCITY,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
