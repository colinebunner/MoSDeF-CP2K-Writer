...
from mosdef_cp2k_writer.classes import SCF
from mosdef_cp2k_writer.classes import XC
from mosdef_cp2k_writer.classes import MGRID
...
def _validate_EXCITATIONS(val, errorLog=[]):
    ...
    if val in EXCITATIONS_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for EXCITATIONS: {}. Valid options are: {}".format(
...
def _validate_PLUS_U_METHOD(val, errorLog=[]):
    ...
    if val in PLUS_U_METHOD_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for PLUS_U_METHOD: {}. Valid options are: {}".format(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "DFT",
                "Variable": "SURFACE_DIPOLE_CORRECTION",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_SURF_DIP_DIR(val, errorLog=[]):
    ...
    if val in SURF_DIP_DIR_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for SURF_DIP_DIR: {}. Valid options are: {}".format(
...
class DFT:
    def __init__(
        ...
        self.__BASIS_SET_FILE_NAME = _validate_BASIS_SET_FILE_NAME(
            BASIS_SET_FILE_NAME, errorLog=self.__errorLog
        )
        self.__CHARGE = _validate_CHARGE(CHARGE, errorLog=self.__errorLog)
        self.__EXCITATIONS = _validate_EXCITATIONS(
            EXCITATIONS, errorLog=self.__errorLog
        )
        self.__MULTIPLICITY = _validate_MULTIPLICITY(
            MULTIPLICITY, errorLog=self.__errorLog
        )
        self.__PLUS_U_METHOD = _validate_PLUS_U_METHOD(
            PLUS_U_METHOD, errorLog=self.__errorLog
        )
        self.__POTENTIAL_FILE_NAME = _validate_POTENTIAL_FILE_NAME(
            POTENTIAL_FILE_NAME, errorLog=self.__errorLog
        )
        self.__RELAX_MULTIPLICITY = _validate_RELAX_MULTIPLICITY(
            RELAX_MULTIPLICITY, errorLog=self.__errorLog
        )
        ...
        self.__SURFACE_DIPOLE_CORRECTION = _validate_SURFACE_DIPOLE_CORRECTION(
            SURFACE_DIPOLE_CORRECTION, errorLog=self.__errorLog
        )
        self.__SURF_DIP_DIR = _validate_SURF_DIP_DIR(
            SURF_DIP_DIR, errorLog=self.__errorLog
        )
        self.__UKS = _validate_UKS(UKS, errorLog=self.__errorLog)
        self.__WFN_RESTART_FILE_NAME = _validate_WFN_RESTART_FILE_NAME(
            WFN_RESTART_FILE_NAME, errorLog=self.__errorLog
        )
        self.__QS = QS.QS(
        ...
        self.__POISSON = POISSON.POISSON(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__PRINT = DFT_PRINT.PRINT(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT",
                "Variable": "ABASIS_SET_FILE_NAME",
                "Success": True,
                "Previous": self.__BASIS_SET_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT",
                "Variable": "RELAX_MULTIPLICITY",
                "Success": True,
                "Previous": self.__RELAX_MULTIPLICITY,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "SURFACE_DIPOLE_CORRECTION",
                    "Success": True,
                    "Previous": self.__SURFACE_DIPOLE_CORRECTION,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT",
                "Variable": "WFN_RESTART_FILE_NAME",
                "Success": True,
                "Previous": self.__WFN_RESTART_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
