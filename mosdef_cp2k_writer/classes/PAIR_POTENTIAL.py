...
def _validate_CALCULATE_C9_TERM(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CALCULATE_C9_TERM: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "XC/VDW_POTENTIAL/PAIR_POTENTIAL",
                "Variable": "LONG_RANGE_CORRECTION",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_MOLECULE_CORRECTION(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MOLECULE_CORRECTION: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_REFERENCE_C9_TERM(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for REFERENCE_C9_TERM: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "XC/VDW_POTENTIAL/PAIR_POTENTIAL",
                "Variable": "SHORT_RANGE_CORRECTION",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_VERBOSE_OUTPUT(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for VERBOSE_OUTPUT: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class PAIR_POTENTIAL:
    def __init__(
        self,
        ATOMPARM=None,
        ATOM_COORDINATION_NUMBERS=None,
        CALCULATE_C9_TERM=None,
        D3BJ_SCALING=None,
        D3_EXCLUDE_KIND=None,
        D3_SCALING=None,
        EPS_CN=None,
        EXP_PRE=None,
        KIND_COORDINATION_NUMBERS=None,
        LONG_RANGE_CORRECTION=None,
        MOLECULE_CORRECTION=None,
        MOLECULE_CORRECTION_C8=None,
        PARAMETER_FILE_NAME=None,
        REFERENCE_C9_TERM=None,
        REFERENCE_FUNCTIONAL=None,
        R_CUTOFF=None,
        SCALING=None,
        SHORT_RANGE_CORRECTION=None,
        SHORT_RANGE_CORRECTION_PARAMETERS=None,
        TYPE=None,
        VERBOSE_OUTPUT=None,
        errorLog=[],
        changeLog=[],
        ...
        self.__ATOM_COORDINATION_NUMBERS = _validate_ATOM_COORDINATION_NUMBERS(
            ATOM_COORDINATION_NUMBERS, errorLog=self.__errorLog
        )
        self.__CALCULATE_C9_TERM = _validate_CALCULATE_C9_TERM(
            CALCULATE_C9_TERM, errorLog=self.__errorLog
        )
        self.__D3BJ_SCALING = _validate_D3BJ_SCALING(
            D3BJ_SCALING, errorLog=self.__errorLog
        )
        self.__D3_EXCLUDE_KIND = _validate_D3_EXCLUDE_KIND(
            D3_EXCLUDE_KIND, errorLog=self.__errorLog
        )
        ...
        self.__KIND_COORDINATION_NUMBERS = _validate_KIND_COORDINATION_NUMBERS(
            KIND_COORDINATION_NUMBERS, errorLog=self.__errorLog
        )
        self.__LONG_RANGE_CORRECTION = _validate_LONG_RANGE_CORRECTION(
            LONG_RANGE_CORRECTION, errorLog=self.__errorLog
        )
        self.__MOLECULE_CORRECTION = _validate_MOLECULE_CORRECTION(
            MOLECULE_CORRECTION, errorLog=self.__errorLog
        )
        self.__MOLECULE_CORRECTION_C8 = _validate_MOLECULE_CORRECTION_C8(
            MOLECULE_CORRECTION_C8, errorLog=self.__errorLog
        )
        self.__PARAMETER_FILE_NAME = _validate_PARAMETER_FILE_NAME(
            PARAMETER_FILE_NAME, errorLog=self.__errorLog
        )
        self.__REFERENCE_C9_TERM = _validate_REFERENCE_C9_TERM(
            REFERENCE_C9_TERM, errorLog=self.__errorLog
        )
        self.__REFERENCE_FUNCTIONAL = _validate_REFERENCE_FUNCTIONAL(
            REFERENCE_FUNCTIONAL, errorLog=self.__errorLog
        )
        ...
        self.__SHORT_RANGE_CORRECTION = _validate_SHORT_RANGE_CORRECTION(
            SHORT_RANGE_CORRECTION, errorLog=self.__errorLog
        )
        self.__SHORT_RANGE_CORRECTION_PARAMETERS = (
            _validate_SHORT_RANGE_CORRECTION_PARAMETERS(
                SHORT_RANGE_CORRECTION_PARAMETERS, errorLog=self.__errorLog
            )
        )
        self.__TYPE = _validate_TYPE(TYPE, errorLog=self.__errorLog)
        self.__VERBOSE_OUTPUT = _validate_VERBOSE_OUTPUT(
            VERBOSE_OUTPUT, errorLog=self.__errorLog
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "ATOM_COORDINATION_NUMBERS",
                "Success": True,
                "Previous": self.__ATOM_COORDINATION_NUMBERS,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "CALCULATE_C9_TERM",
                    "Success": True,
                    "Previous": self.__CALCULATE_C9_TERM,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "D3BJ_SCALING",
                "Success": True,
                "Previous": self.__D3BJ_SCALING,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT",
                "Variable": "KIND_COORDINATION_NUMBERS",
                "Success": True,
                "Previous": self.__KIND_COORDINATION_NUMBERS,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "LONG_RANGE_CORRECTION",
                    "Success": True,
                    "Previous": self.__LONG_RANGE_CORRECTION,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "MOLECULE_CORRECTION",
                    "Success": True,
                    "Previous": self.__MOLECULE_CORRECTION,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "MOLECULE_CORRECTION_C8",
                "Success": True,
                "Previous": self.__MOLECULE_CORRECTION_C8,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "PARAMETER_FILE_NAME",
                "Success": True,
                "Previous": self.__PARAMETER_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "REFERENCE_C9_TERM",
                    "Success": True,
                    "Previous": self.__REFERENCE_C9_TERM,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "REFERENCE_FUNCTIONAL",
                "Success": True,
                "Previous": self.__REFERENCE_FUNCTIONAL,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "SHORT_RANGE_CORRECTION",
                    "Success": True,
                    "Previous": self.__SHORT_RANGE_CORRECTION,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT.XC.VDW_POT.PAIR_POT",
                "Variable": "SHORT_RANGE_CORRECTION_PARAMETERS",
                "Success": True,
                "Previous": self.__SHORT_RANGE_CORRECTION_PARAMETERS,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "VERBOSE_OUTPUT",
                    "Success": True,
                    "Previous": self.__VERBOSE_OUTPUT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
