...
def _validate_RMVOLUME(val, errorLog=[]):
    ...
    if val is None or ti.is_number(val):
        ...
        errorMessage = "Invalid option for RMVOLUME: {}. Must be an number.".format(val)
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
                "Type": "init",
...
class BOX_DISPLACEMENTS:
    def __init__(
        self, RMCLTRANS=None, RMVOLUME=None, errorLog=[], changeLog=[], location=""
    ):
    ...
    def RMCLTRANS(self, val):
        ...
        if val is None or ti.is_number(val):
            ...
            errorMessage = (
                "Invalid option for RMCLTRANS: {}. It should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def RMVOLUME(self, val):
        ...
        if val is None or ti.is_number(val):
            ...
            errorMessage = (
                "Invalid option for RMVOLUME: {}. It should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
