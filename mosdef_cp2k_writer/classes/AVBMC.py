...
def _validate_AVBMC_ATOM(val, errorLog=[]):
    ...
    if ti.is_list_of_integers(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for AVBMC_ATOM: {}. It should be a list of integers".format(
                val
            )
        )
        errorLog.append(
...
def _validate_AVBMC_RMAX(val, errorLog=[]):
    ...
    if ti.is_list_of_numbers(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for AVBMC_RMAX: {}. It should be a list of numbers".format(
                val
            )
        )
        errorLog.append(
...
def _validate_AVBMC_RMIN(val, errorLog=[]):
    ...
    if ti.is_list_of_numbers(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for AVBMC_RMIN: {}. It should be a list of numbers.".format(
                val
            )
        )
        errorLog.append(
...
def _validate_PBIAS(val, errorLog=[]):
    ...
    if ti.is_list_of_numbers(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for PBIAS: {}. It should be a list of numbers.".format(val)
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
...
class AVBMC:
    ...
    def AVBMC_ATOM(self, val):
        if ti.is_list_of_integers(val) or val is None:
            ...
            errorMessage = "Invalid option for AVBMC_ATOM: {}. Should be a list of integers".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def AVBMC_RMAX(self, val):
        if ti.is_list_of_numbers(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for AVBMC_RMAX: {}. Should be a list of numbers".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def AVBMC_RMIN(self, val):
        if ti.is_list_of_numbers(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for AVBMC_RMIN: {}. Should be a list of numbers".format(
                    val
                )
            )
            self.__changeLog.append(
    ...
    def PBIAS(self, val):
        if ti.is_list_of_numbers(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for PBIAS: {}. Should be a list of numbers".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
