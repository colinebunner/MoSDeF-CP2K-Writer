...
class FM:
    def __init__(
        ...
        NCOL_BLOCKS=None,
        NROW_BLOCKS=None,
        TYPE_OF_MATRIX_MULTIPLICATION=None,
        errorLog=[],
        changeLog=[],
        location="",
    ):
    ...
    def FORCE_BLOCK_SIZE(self, val):
        if isinstance(val, bool):
            self.__changeLog.append(
                {
                    ...
                    "Module": "DBCSR",
                    "Variable": "FORCE_BLOCK_SIZE",
                    "Success": True,
                    "Previous": self.__FORCE_BLOCK_SIZE,
                    "New": val,
                    "ErrorMessage": None,
            ...
            errorMessage = "FORCE_BLOCK_SIZE must be a boolean. You passed {}.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def NCOL_BLOCKS(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "NCOL_BLOCKS",
                    "Success": True,
                    "Previous": self.__NCOL_BLOCKS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "NCOL_BLOCKS must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def NROW_BLOCKS(self, val):
        if utilities.is_positive_integer(val):
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "NROW_BLOCKS",
                    "Success": True,
                    "Previous": self.__NROW_BLOCKS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "NROW_BLOCKS must be a positive integer. You passed {}.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def TYPE_OF_MATRIX_MULTIPLICATION(self, val):
        ...
        if val in TYPE_OF_MATRIX_MULTIPLICATION_VALS:
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
                    "Module": "DBCSR",
                    "Variable": "TYPE_OF_MATRIX_MULTIPLICATION",
                    "Success": True,
                    "Previous": self.__TYPE_OF_MATRIX_MULTIPLICATION,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            errorMessage = (
                "TYPE_OF_MATRIX_MULTIPLICATION val {} not understood. Possible values are: {}"
