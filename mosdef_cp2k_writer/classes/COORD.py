        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "FORCE_EVAL.SUBSYS.COORD",
                "Variable": "SCALED",
...
class COORD:
    def __init__(
        ...
        self.__DEFAULT_KEYWORD = _validate_DEFAULT_KEYWORD(
            DEFAULT_KEYWORD, errorLog=self.__errorLog
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "FORCE_EVAL.SUBSYS.COORD",
                "Variable": "DEFAULT_KEYWORD",
                "Success": True,
                "Previous": self.__DEFAULT_KEYWORD,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
    ...
    def SCALED(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for SCALED: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
