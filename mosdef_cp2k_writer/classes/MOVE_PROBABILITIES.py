...
class MOVE_PROBABILITIES:
    def __init__(
        ...
        self.__BOX_PROBABILITIES = BOX_PROBABILITIES.BOX_PROBABILITIES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__MOL_PROBABILITIES = MOL_PROBABILITIES.MOL_PROBABILITIES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
    ...
    def PMAVBMC(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = "Invalid option for PMAVBMC: {}. Should be a number.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def PMCLTRANS(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for PMCLTRANS: {}.  Should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def PMHMC(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = "Invalid option for PMHMC: {}. Should be a number.".format(
                val
            )
            self.__changeLog.append(
                {
    ...
    def PMTRAION(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for PMTRAION: {}.  Should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def PMTRANS(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for PMTRANS: {}.  Should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def PMVOLUME(self, val):
        ...
        if val is None or utilities.is_number(val):
            ...
            errorMessage = (
                "Invalid option for PMVOLUME: {}.  Should be a number.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
