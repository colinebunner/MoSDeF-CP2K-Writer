        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "FORCE_EVAL/DFT/PRINT/E_DENSITY_CUBE",
...
def _validate_TOTAL_DENSITY(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for TOTAL_DENSITY: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_XRD_INTERFACE(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for XRD_INTERFACE: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class E_DENSITY_CUBE:
    def __init__(
        ...
        self.__TOTAL_DENSITY = _validate_TOTAL_DENSITY(
            TOTAL_DENSITY, errorLog=self.__errorLog
        )
        self.__XRD_INTERFACE = _validate_XRD_INTERFACE(
            XRD_INTERFACE, errorLog=self.__errorLog
        )
