...
class PRINT:
    def __init__(self, errorLog=[], changeLog=[], location=""):
        ...
        # self.__FORCES
        self.__FORCES = forces.FORCES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__RESTART_HISTORY = rest.RESTART_HISTORY(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__RESTART = restart.RESTART(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__TRAJECTORY = traj.TRAJECTORY(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__VELOCITIES = vel.VELOCITIES(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
        self.__STRESS = STRESS.STRESS(
            errorLog=self.__errorLog,
            changeLog=self.__changeLog,
            location=self.__location,
        )
