...
def _validate_USE_FINER_GRID(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for USE_FINER_GRID: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_XC_SMOOTH_RHO(val, errorLog=[]):
    ...
    if val in XC_SMOOTH_RHO_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for XC_SMOOTH_RHO: {}. Valid options are: {}".format(
...
class XC_GRID:
    def __init__(
        ...
        self.__USE_FINER_GRID = _validate_USE_FINER_GRID(
            USE_FINER_GRID, errorLog=self.__errorLog
        )
        self.__XC_DERIV = _validate_XC_DERIV(XC_DERIV, errorLog=self.__errorLog)
        self.__XC_SMOOTH_RHO = _validate_XC_SMOOTH_RHO(
            XC_SMOOTH_RHO, errorLog=self.__errorLog
        )
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "USE_FINER_GRID",
                    "Success": True,
                    "Previous": self.__USE_FINER_GRID,
                    "New": val,
                    "ErrorMessage": None,
    ...
    def XC_DERIV(self, val):
        ...
        if val in XC_DERIV_VALS or val is None:
            ...
            errorMessage = (
                "Invalid option for XC_DERIV: {}. Valid options are: {}".format(
                    val, XC_DERIV_VALS
                )
            )
            self.__changeLog.append(
