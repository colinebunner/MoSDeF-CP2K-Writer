...
def _validate_IUPCLTRANS(val, errorLog=[]):
    ...
    if ti.is_integer(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for IUPCLTRANS: {}. It should be an integer.".format(val)
        )
        errorLog.append(
            {
...
def _validate_IUPTRANS(val, errorLog=[]):
    ...
    if ti.is_integer(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for IUPTRANS: {}. It should be an integer.".format(val)
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
...
def _validate_IUPVOLUME(val, errorLog=[]):
    ...
    if ti.is_integer(val) or (val is None):
        ...
        errorMessage = (
            "Invalid option for IUPVOLUME: {}. It should be an integer.".format(val)
        )
        errorLog.append(
            {
                "Date": datetime.datetime.now(),
...
class MOVE_UPDATES:
    ...
    def IUPCLTRANS(self, val):
        if ti.is_integer(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for IUPCLTRANS: {}. Should be an integer.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def IUPTRANS(self, val):
        if ti.is_integer(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for IUPTRANS: {}. Should be an integer.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
    ...
    def IUPVOLUME(self, val):
        if ti.is_integer(val) or val is None:
            ...
            errorMessage = (
                "Invalid option for IUPVOLUME: {}. Should be an integer.".format(val)
            )
            self.__changeLog.append(
                {
                    "Date": datetime.datetime.now(),
