...
def _validate_region(val, errorLog=[]):
    ...
    if val in REGION_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MD THERMOSTAT REGION: {}. Valid options are: {}".format(
                val, REGION_VALS
            )
        )
        errorLog.append(
...
def _validate_type(val, errorLog=[]):
    ...
    if val in TYPE_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MD THERMOSTAT TYPE: {}. Valid options are: {}".format(
                val, TYPE_VALS
            )
        )
        errorLog.append(
