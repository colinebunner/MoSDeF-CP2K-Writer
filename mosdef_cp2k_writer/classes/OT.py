        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SCF OT",
                "Variable": "BROYDEN_ADAPTIVE_SIGMA",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_BROYDEN_ENABLE_FLIP(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for BROYDEN_ENABLE_FLIP: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SCF OT",
                "Variable": "BROYDEN_FORGET_HISTORY",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_LINESEARCH(val, errorLog=[]):
    ...
    if val in LINESEARCH_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for LINESEARCH: {}. Valid options are: {}".format(
                val, LINESEARCH_VALS
            )
        )
        errorLog.append(
...
def _validate_NONDIAG_ENERGY(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for NONDIAG_ENERGY: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "SCF OT",
                "Variable": "OCCUPATION_PRECONDITIONER",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_ON_THE_FLY_LOC(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for ON_THE_FLY_LOC: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_ORTHO_IRAC(val, errorLog=[]):
    ...
    if val in ORTHO_IRAC_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for ORTHO_IRAC: {}. Valid options are: {}".format(
                val, ORTHO_IRAC_VALS
            )
        )
        errorLog.append(
...
def _validate_PRECONDITIONER(val, errorLog=[]):
    ...
    if val in PRECONDITIONER_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for PRECONDITIONER: {}. Valid options are: {}".format(
...
def _validate_PRECOND_SOLVER(val, errorLog=[]):
    ...
    if val in PRECOND_SOLVER_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for PRECOND_SOLVER: {}. Valid options are: {}".format(
                val, PRECONDITIONER_VALS
            )
        )
        errorLog.append(
...
class OT:
    def __init__(
        ...
        self.__BROYDEN_ADAPTIVE_SIGMA = _validate_BROYDEN_ADAPTIVE_SIGMA(
            BROYDEN_ADAPTIVE_SIGMA, errorLog=self.__errorLog
        )
        self.__BROYDEN_BETA = _validate_BROYDEN_BETA(
            BROYDEN_BETA, errorLog=self.__errorLog
        )
        self.__BROYDEN_ENABLE_FLIP = _validate_BROYDEN_ENABLE_FLIP(
            BROYDEN_ENABLE_FLIP, errorLog=self.__errorLog
        )
        self.__BROYDEN_ETA = _validate_BROYDEN_ETA(
            BROYDEN_ETA, errorLog=self.__errorLog
        )
        self.__BROYDEN_FORGET_HISTORY = _validate_BROYDEN_FORGET_HISTORY(
            BROYDEN_FORGET_HISTORY, errorLog=self.__errorLog
        )
        self.__BROYDEN_GAMMA = _validate_BROYDEN_GAMMA(
            BROYDEN_GAMMA, errorLog=self.__errorLog
        )
        self.__BROYDEN_OMEGA = _validate_BROYDEN_OMEGA(
            BROYDEN_OMEGA, errorLog=self.__errorLog
        )
        self.__BROYDEN_SIGMA = _validate_BROYDEN_SIGMA(
            BROYDEN_SIGMA, errorLog=self.__errorLog
        )
        self.__BROYDEN_SIGMA_DECREASE = _validate_BROYDEN_SIGMA_DECREASE(
            BROYDEN_SIGMA_DECREASE, errorLog=self.__errorLog
        )
        self.__BROYDEN_SIGMA_MIN = _validate_BROYDEN_SIGMA_MIN(
            BROYDEN_SIGMA_MIN, errorLog=self.__errorLog
        )
        ...
        self.__EPS_IRAC_FILTER_MATRIX = _validate_EPS_IRAC_FILTER_MATRIX(
            EPS_IRAC_FILTER_MATRIX, errorLog=self.__errorLog
        )
        self.__EPS_IRAC_QUICK_EXIT = _validate_EPS_IRAC_QUICK_EXIT(
            EPS_IRAC_QUICK_EXIT, errorLog=self.__errorLog
        )
        self.__EPS_IRAC_SWITCH = _validate_EPS_IRAC_SWITCH(
            EPS_IRAC_SWITCH, errorLog=self.__errorLog
        )
        self.__EPS_TAYLOR = _validate_EPS_TAYLOR(EPS_TAYLOR, errorLog=self.__errorLog)
        self.__GOLD_TARGET = _validate_GOLD_TARGET(
            GOLD_TARGET, errorLog=self.__errorLog
        )
        self.__IRAC_DEGREE = _validate_IRAC_DEGREE(
            IRAC_DEGREE, errorLog=self.__errorLog
        )
        ...
        self.__NONDIAG_ENERGY = _validate_NONDIAG_ENERGY(
            NONDIAG_ENERGY, errorLog=self.__errorLog
        )
        self.__NONDIAG_ENERGY_STRENGTH = _validate_NONDIAG_ENERGY_STRENGTH(
            NONDIAG_ENERGY_STRENGTH, errorLog=self.__errorLog
        )
        self.__N_HISTORY_VEC = _validate_N_HISTORY_VEC(
            N_HISTORY_VEC, errorLog=self.__errorLog
        )
        self.__OCCUPATION_PRECONDITIONER = _validate_OCCUPATION_PRECONDITIONER(
            OCCUPATION_PRECONDITIONER, errorLog=self.__errorLog
        )
        self.__ON_THE_FLY_LOC = _validate_ON_THE_FLY_LOC(
            ON_THE_FLY_LOC, errorLog=self.__errorLog
        )
        self.__ORTHO_IRAC = _validate_ORTHO_IRAC(ORTHO_IRAC, errorLog=self.__errorLog)
        self.__PRECONDITIONER = _validate_PRECONDITIONER(
            PRECONDITIONER, errorLog=self.__errorLog
        )
        self.__PRECOND_SOLVER = _validate_PRECOND_SOLVER(
            PRECOND_SOLVER, errorLog=self.__errorLog
        )
    ...
    def SECTION_PARAMETERS(self, val):
        ...
        if val in SECTION_PARAMETERS_VALS:
            ...
            errorMessage = "Invalid option for Section parameter OT: {}. Valid options are: {}".format(
                val, SECTION_PARAMETERS_VALS
            )
            self.__changeLog.append(
                {
    ...
    def ALGORITHM(self, val):
        ...
        if val in ALGORITHM_VALS:
            ...
            errorMessage = (
                "Invalid option for ALGORITHM: {}. Valid options are: {}".format(
                    val, ALGORITHM_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "BROYDEN_ADAPTIVE_SIGMA",
                    "Success": True,
                    "Previous": self.__BROYDEN_ADAPTIVE_SIGMA,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "BROYDEN_ENABLE_FLIP",
                    "Success": True,
                    "Previous": self.__BROYDEN_ENABLE_FLIP,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_ETA",
                "Success": True,
                "Previous": self.__BROYDEN_ETA,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "BROYDEN_FORGET_HISTORY",
                    "Success": True,
                    "Previous": self.__BROYDEN_FORGET_HISTORY,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_GAMMA",
                "Success": True,
                "Previous": self.__BROYDEN_GAMMA,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_OMEGA",
                "Success": True,
                "Previous": self.__BROYDEN_OMEGA,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_SIGMA",
                "Success": True,
                "Previous": self.__BROYDEN_SIGMA,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_SIGMA_DECREASE",
                "Success": True,
                "Previous": self.__BROYDEN_SIGMA_DECREASE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "BROYDEN_SIGMA_MIN",
                "Success": True,
                "Previous": self.__BROYDEN_SIGMA_MIN,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
    ...
    def CHOLESKY(self, val):
        ...
        if val in CHOLESKY_VALS:
            ...
            errorMessage = (
                "Invalid option for CHOLESKY: {}. Valid options are: {}".format(
                    val, CHOLESKY_VALS
                )
            )
            self.__changeLog.append(
    ...
    def ENERGIES(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for ENERGIES: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "EPS_IRAC_FILTER_MATRIX",
                "Success": True,
                "Previous": self.__EPS_IRAC_FILTER_MATRIX,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "EPS_IRAC_QUICK_EXIT",
                "Success": True,
                "Previous": self.__EPS_IRAC_QUICK_EXIT,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "EPS_IRAC_SWITCH",
                "Success": True,
                "Previous": self.__EPS_IRAC_SWITCH,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "GOLD_TARGET",
                "Success": True,
                "Previous": self.__GOLD_TARGET,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
    ...
    def MINIMIZER(self, val):
        ...
        if val in MINIMIZER_VALS:
            ...
            errorMessage = (
                "Invalid option for MINIMIZER: {}. Valid options are: {}".format(
                    val, MINIMIZER_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "NONDIAG_ENERGY",
                    "Success": True,
                    "Previous": self.__NONDIAG_ENERGY,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "SCF OT",
                "Variable": "NONDIAG_ENERGY_STRENGTH",
                "Success": True,
                "Previous": self.__NONDIAG_ENERGY_STRENGTH,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "OCCUPATION_PRECONDITIONER",
                    "Success": True,
                    "Previous": self.__OCCUPATION_PRECONDITIONER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "ON_THE_FLY_LOC",
                    "Success": True,
                    "Previous": self.__ON_THE_FLY_LOC,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "PRECONDITIONER",
                    "Success": True,
                    "Previous": self.__PRECONDITIONER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "PRECOND_SOLVER",
                    "Success": True,
                    "Previous": self.__PRECOND_SOLVER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def SAFE_DIIS(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for SAFE_DIIS: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
    ...
    def ROTATION(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for ROTATION: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
