...
def _validate_CLUSTER_EMBED_SUBSYS(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for CLUSTER_EMBED_SUBSYS: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_DFET_EMBEDDED(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for DFET_EMBEDDED: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_DMFET_EMBEDDED(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for DMFET_EMBEDDED: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_EXTRAPOLATION(val, errorLog=[]):
    ...
    if val in EXTRAPOLATION_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for EXTRAPOLATION: {}. Valid options are: {}".format(
        ...
        errorLog.append(
            {
                ...
                "Type": "init",
                "Module": "DFT/QS",
                "Variable": "HIGH_LEVEL_EMBED_SUBSYS",
                "ErrorMessage": errorMessage,
            }
        )
        raise TypeError
...
def _validate_MAP_CONSISTENT(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for MAP_CONSISTENT: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_PW_GRID_BLOCKED(val, errorLog=[]):
    ...
    if val in PW_GRID_BLOCKED_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for PW_GRID_BLOCKED: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_QUADRATURE(val, errorLog=[]):
    ...
    if val in QUADRATURE_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for QUADRATURE: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
def _validate_REF_EMBED_SUBSYS(val, errorLog=[]):
    ...
    if val in BOOL_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for REF_EMBED_SUBSYS: {}. Valid options are: {}".format(
                val, BOOL_VALS
            )
        )
        errorLog.append(
...
class QS:
    def __init__(
        ...
        ALMO_SCF=None,
        ALPHA0_HARD=None,
        CLUSTER_EMBED_SUBSYS=None,
        CORE_PPL=None,
        DFET_EMBEDDED=None,
        DMFET_EMBEDDED=None,
        EMBED_CUBE_FILE_NAME=None,
        EMBED_RESTART_FILE_NAME=None,
        EMBED_SPIN_CUBE_FILE_NAME=None,
        EPSFIT=None,
        EPSISO=None,
        EPSRHO0=None,
        EPSSVD=None,
        EPS_CORE_CHARGE=None,
        EPS_CPC=None,
        EPS_DEFAULT=None,
        EPS_FILTER_MATRIX=None,
        EPS_GVG_RSPACE=None,
        EPS_KG_ORB=None,
        EPS_PGF_ORB=None,
        EPS_PPL=None,
        ...
        METHOD=None,
        PW_GRID=None,
        PW_GRID_BLOCKED=None,
        PW_GRID_LAYOUT=None,
        QUADRATURE=None,
        REF_EMBED_SUBSYS=None,
        STO_NG=None,
        TRANSPORT=None,
        errorLog=[],
        changeLog=[],
        ...
        self.__ALPHA0_HARD = _validate_ALPHA0_HARD(
            ALPHA0_HARD, errorLog=self.__errorLog
        )
        self.__CLUSTER_EMBED_SUBSYS = _validate_CLUSTER_EMBED_SUBSYS(
            CLUSTER_EMBED_SUBSYS, errorLog=self.__errorLog
        )
        self.__CORE_PPL = _validate_CORE_PPL(CORE_PPL, errorLog=self.__errorLog)
        self.__DFET_EMBEDDED = _validate_DFET_EMBEDDED(
            DFET_EMBEDDED, errorLog=self.__errorLog
        )
        self.__DMFET_EMBEDDED = _validate_DMFET_EMBEDDED(
            DMFET_EMBEDDED, errorLog=self.__errorLog
        )
        self.__EMBED_CUBE_FILE_NAME = _validate_EMBED_CUBE_FILE_NAME(
            EMBED_CUBE_FILE_NAME, errorLog=self.__errorLog
        )
        self.__EMBED_RESTART_FILE_NAME = _validate_EMBED_RESTART_FILE_NAME(
            EMBED_RESTART_FILE_NAME, errorLog=self.__errorLog
        )
        self.__EMBED_SPIN_CUBE_FILE_NAME = _validate_EMBED_SPIN_CUBE_FILE_NAME(
            EMBED_SPIN_CUBE_FILE_NAME, errorLog=self.__errorLog
        )
        ...
        self.__EPS_CORE_CHARGE = _validate_EPS_CORE_CHARGE(
            EPS_CORE_CHARGE, errorLog=self.__errorLog
        )
        self.__EPS_CPC = _validate_EPS_CPC(EPS_CPC, errorLog=self.__errorLog)
        self.__EPS_DEFAULT = _validate_EPS_DEFAULT(
            EPS_DEFAULT, errorLog=self.__errorLog
        )
        self.__EPS_FILTER_MATRIX = _validate_EPS_FILTER_MATRIX(
            EPS_FILTER_MATRIX, errorLog=self.__errorLog
        )
        self.__EPS_GVG_RSPACE = _validate_EPS_GVG_RSPACE(
            EPS_GVG_RSPACE, errorLog=self.__errorLog
        )
        self.__EPS_KG_ORB = _validate_EPS_KG_ORB(EPS_KG_ORB, errorLog=self.__errorLog)
        self.__EPS_PGF_ORB = _validate_EPS_PGF_ORB(
            EPS_PGF_ORB, errorLog=self.__errorLog
        )
        ...
        self.__EPS_RHO_GSPACE = _validate_EPS_RHO_GSPACE(
            EPS_RHO_GSPACE, errorLog=self.__errorLog
        )
        self.__EPS_RHO_RSPACE = _validate_EPS_RHO_RSPACE(
            EPS_RHO_RSPACE, errorLog=self.__errorLog
        )
        self.__EXTRAPOLATION = _validate_EXTRAPOLATION(
            EXTRAPOLATION, errorLog=self.__errorLog
        )
        self.__EXTRAPOLATION_ORDER = _validate_EXTRAPOLATION_ORDER(
            EXTRAPOLATION_ORDER, errorLog=self.__errorLog
        )
        self.__FORCE_PAW = _validate_FORCE_PAW(FORCE_PAW, errorLog=self.__errorLog)
        self.__HIGH_LEVEL_EMBED_SUBSYS = _validate_HIGH_LEVEL_EMBED_SUBSYS(
            HIGH_LEVEL_EMBED_SUBSYS, errorLog=self.__errorLog
        )
        ...
        self.__MAP_CONSISTENT = _validate_MAP_CONSISTENT(
            MAP_CONSISTENT, errorLog=self.__errorLog
        )
        self.__MAX_RAD_LOCAL = _validate_MAX_RAD_LOCAL(
            MAX_RAD_LOCAL, errorLog=self.__errorLog
        )
        ...
        self.__PW_GRID_BLOCKED = _validate_PW_GRID_BLOCKED(
            PW_GRID_BLOCKED, errorLog=self.__errorLog
        )
        self.__PW_GRID_LAYOUT = _validate_PW_GRID_LAYOUT(
            PW_GRID_LAYOUT, errorLog=self.__errorLog
        )
        self.__QUADRATURE = _validate_QUADRATURE(QUADRATURE, errorLog=self.__errorLog)
        self.__REF_EMBED_SUBSYS = _validate_REF_EMBED_SUBSYS(
            REF_EMBED_SUBSYS, errorLog=self.__errorLog
        )
    ...
    def ALMO_SCF(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for ALMO_SCF: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "ALPHA0_HARD",
                "Success": True,
                "Previous": self.__ALPHA0_HARD,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "CLUSTER_EMBED_SUBSYS",
                    "Success": True,
                    "Previous": self.__CLUSTER_EMBED_SUBSYS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def CORE_PPL(self, val):
        ...
        if val in CORE_PPL_VALS:
            ...
            errorMessage = (
                "Invalid option for CORE_PPL: {}. Valid options are: {}".format(
                    val, CORE_PPL_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "DMFET_EMBEDDED",
                    "Success": True,
                    "Previous": self.__DMFET_EMBEDDED,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EMBED_CUBE_FILE_NAME",
                "Success": True,
                "Previous": self.__EMBED_CUBE_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EMBED_RESTART_FILE_NAME",
                "Success": True,
                "Previous": self.__EMBED_CUBE_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EMBED_SPIN_CUBE_FILE_NAME",
                "Success": True,
                "Previous": self.__EMBED_CUBE_FILE_NAME,
                "New": val,
                "ErrorMessage": None,
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_CORE_CHARGE",
                "Success": True,
                "Previous": self.__EPS_CORE_CHARGE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_DEFAULT",
                "Success": True,
                "Previous": self.__EPS_DEFAULT,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_FILTER_MATRIX",
                "Success": True,
                "Previous": self.__EPS_FILTER_MATRIX,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_GVG_RSPACE",
                "Success": True,
                "Previous": self.__EPS_GVG_RSPACE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_PGF_ORB",
                "Success": True,
                "Previous": self.__EPS_PGF_ORB,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_RHO_GSPACE",
                "Success": True,
                "Previous": self.__EPS_RHO_GSPACE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "EPS_RHO_RSPACE",
                "Success": True,
                "Previous": self.__EPS_RHO_RSPACE,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "EXTRAPOLATION_ORDER",
                    "Success": True,
                    "Previous": self.__EXTRAPOLATION_ORDER,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def FORCE_PAW(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for FORCE_PAW: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "HIGH_LEVEL_EMBED_SUBSYS",
                    "Success": True,
                    "Previous": self.__HIGH_LEVEL_EMBED_SUBSYS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
    ...
    def KG_METHOD(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for KG_METHOD: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
    ...
    def LS_SCF(self, val):
        ...
        if val in BOOL_VALS:
            ...
            errorMessage = (
                "Invalid option for LS_SCF: {}. Valid options are: {}".format(
                    val, BOOL_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "MAP_CONSISTENT",
                    "Success": True,
                    "Previous": self.__MAP_CONSISTENT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/QS",
                "Variable": "MAX_RAD_LOCAL",
                "Success": True,
                "Previous": self.__MAX_RAD_LOCAL,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
    ...
    def METHOD(self, val):
        ...
        if val in METHOD_VALS:
            ...
            errorMessage = (
                "Invalid option for METHOD: {}. Valid options are: {}".format(
                    val, METHOD_VALS
                )
            )
            self.__changeLog.append(
    ...
    def PW_GRID(self, val):
        ...
        if val in PW_GRID_VALS:
            ...
            errorMessage = (
                "Invalid option for PW_GRID: {}. Valid options are: {}".format(
                    val, PW_GRID_VALS
                )
            )
            self.__changeLog.append(
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "PW_GRID_BLOCKED",
                    "Success": True,
                    "Previous": self.__PW_GRID_BLOCKED,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "PW_GRID_LAYOUT",
                    "Success": True,
                    "Previous": self.__PW_GRID_LAYOUT,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
            ...
            self.__changeLog.append(
                {
                    ...
                    "Variable": "REF_EMBED_SUBSYS",
                    "Success": True,
                    "Previous": self.__REF_EMBED_SUBSYS,
                    "New": val,
                    "ErrorMessage": None,
                    "Location": self.__location,
                }
