...
def _validate_EWALD_TYPE(val, errorLog=[]):
    ...
    if val in EWALD_TYPE_VALS or (val is None):
        ...
        errorMessage = (
            "Invalid option for EWALD_TYPE: {}. Valid options are: {}".format(
                val, EWALD_TYPE_VALS
            )
        )
        errorLog.append(
...
class EWALD:
    def __init__(
        ...
        self.__EWALD_ACCURACY = _validate_EWALD_ACCURACY(
            EWALD_ACCURACY, errorLog=self.__errorLog
        )
        ...
        self.__changeLog.append(
            {
                "Date": datetime.datetime.now(),
                "Module": "DFT/POISSON/EWALD",
                "Variable": "EWALD_ACCURACY",
                "Success": True,
                "Previous": self.__EWALD_ACCURACY,
                "New": val,
                "ErrorMessage": None,
                "Location": self.__location,
            }
